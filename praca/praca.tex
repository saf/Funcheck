...
\begin{defi}[Object state]
  The \emph{state} of object $o$, or $st(o)$ is defined inductively as
  follows:
  \begin{itemize}
  \item For each instance field $f$ of $o$:
    \begin{itemize}
    \item if $f$ is of primitive type, $f \in o$ where $f$ is
      understood as the value of the field, 
    \item if $f$ is of reference type, $f \in o$ where $f$ is 
      understood as the heap address of the referenced object. 
    \item if $f$ is 
    \end{itemize}
  \end{itemize}
\end{defi}
