...
\end{description}
This paper also contains one appendix, Appendix \ref{chap:cd}, which
lists the contents of the CD attached to this document.
...
There are two basic flavors of object ownership:
\begin{itemize}
...
representation objects to the outside. 
